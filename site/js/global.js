...
root.style.setProperty("--main", settings.mainColor || "#006bcc");
root.style.setProperty("--background", settings.backgroundColor || "#202020");
root.setAttribute("round", settings.round);
