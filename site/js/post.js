...
fetch(`/api/search?id=${postId}`)
  ...
  .then(async (post) => {
    ...
    postLove.id = "love";
    const postSave = document.createElement("div");
    postSave.style = "--img: url(/media/save.png)";
    postSave.classList.add("img");
    postSave.onclick = savePost;
    postSave.id = "save";
    const postList = document.createElement("div");
    postList.style = "--img: url(/media/list-add.png)";
...
function addToList(l) {
  ...
  if (list.find((p) => p.id == postId)) {
    ...
    document.getElementById(`addto:${l}`).style =
      "--img: url(/media/list-add.png)";
    document.getElementById(`addto:${l}`).classList.remove("active");
    if (l == "loves")
      document.getElementById("love").classList.remove("active");
    else if (l == "saves")
      document.getElementById("save").classList.remove("active");
    ...
    localStorage.setItem(l, JSON.stringify(list));
    document.getElementById(`addto:${l}`).style =
      "--img: url(/media/list-added.png)";
    document.getElementById(`addto:${l}`).classList.add("active");
    if (l == "loves") document.getElementById("love").classList.add("active");
    else if (l == "saves")
      document.getElementById("save").classList.add("active");
  }
}
